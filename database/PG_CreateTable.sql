CREATE DATABASE IF NOT EXISTS kltn_nhahang;
-- 1️⃣ Nhân viên
...
CREATE TABLE customers (
    idcustomers BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
CREATE TABLE carts (
    ...
    status TEXT CHECK (status IN ('ACTIVE','ORDERED','CANCELLED')) DEFAULT 'ACTIVE',
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE cart_items (
    ...
    status TEXT CHECK (status IN ('IN_CART','ORDERED')) DEFAULT 'IN_CART',
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE orders (
    ...
    status TEXT CHECK (status IN ('NEW','IN_PROGRESS','DONE','PAID','CANCELLED')) DEFAULT 'NEW',
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE payments (
    ...
    admin_id BIGINT,
    method TEXT CHECK (method IN ('BANKING','CASH')) NOT NULL,
    amount DECIMAL(12,2),
